    ...
    function d() {
        function e(a) {
            this.component = a, this.instances = [], this.addInstance = function(a) {
                ...
                var b = this.instances.filter(function(b) {
                    return b.instance == a
                })[0],
                    c = this.instances.indexOf(b);
                c > -1 && this.instances.splice(c, 1), this.instances.length || d.removeComponentInfo(this)
            }
        }
        function f(a) {
            this.instance = a, this.events = [], this.addTrigger = function() {}, this.addBind = function(a) {
                this.events.push(a), d.events.push(a)
            }, this.removeBind = function(a) {
                for (var b = 0, d; d = this.events[b]; b++) c(d, a) && this.events.splice(b, 1)
            }
        }
        var d = this;
        (this.reset = function() {
            ...
            var a = b(this, arguments),
                c = d.findInstanceInfo(this);
            c && c.addTrigger(a)
        }, this.on = function(c) {
            var e = a.toArray(arguments, 1),
                f = d.findInstanceInfo(this),
                g;
            if (f) {
...
define("components/flight/lib/component", ["./advice", "./utils", "./compose", "./registry"], function(a, b, c, d) {
    ...
    function g() {
        this.trigger("componentTearDown"), f(d.findInstanceInfo(this))
    }
    function h() {
    ...
    function i(a, b) {
        try {
            ...
            throw console.log("unserializable data for event", a, ":", b), new Error(["The event", a, "on component", this.describe, "was triggered with non-serializable data"].join(" "))
        }
    }
    function j() {
        this.trigger = function() {
            var a, c, d, e, f, g = b.toArray(arguments),
                h = g[g.length - 1];
            return typeof h != "string" && (!h || !h.defaultBehavior) && (d = g.pop()), a = g.length == 2 ? $(g.shift()) : this.$node, e = g[0], e.defaultBehavior && (f = e.defaultBehavior, e = $.Event(e.type)), c = e.type || e, window.DEBUG && window.postMessage && i.call(this, c, d), typeof this.attr.eventData == "object" && (d = $.extend(!0, {}, this.attr.eventData, d)), a.trigger(e || c, d), f && !e.isDefaultPrevented() && (this[f] || f).call(this), a
        }, this.on = function() {
            var a, c, d, e, f = b.toArray(arguments);
            typeof f[f.length - 1] == "object" ? e = b.delegate(this.resolveDelegateRules(f.pop())) : e = f.pop(), a = f.length == 2 ? $(f.shift()) : this.$node, c = f[0];
    ...
    function l() {
        ...
        var f = b.toArray(arguments);
        return g.toString = function() {
            var a = f.map(function(a) {
                if (a.name == null) {
            ...
            return a
        }, g.describe = g.toString(), g.attachTo = k, g.teardownAll = h, f.unshift(j, a.withAdvice, d.withRegistration), c.mixin(g.prototype, f), g
    }
    var e = /function (.*?)\s?\(/;
    ...
    function withScribe() {
        ...
        this.scribe = function() {
            ...
            if (b[0]) {
                ...
                if (e.scribeContext || e.scribeData) f = e.scribeContext, g = e.scribeData;
...
define("app/utils/params", ["module", "require", "exports", "app/utils/querystring"], function(module, require, exports) {
    var qs = require("app/utils/querystring"),
...
define("app/data/with_auth_token", ["module", "require", "exports", "app/utils/auth_token", "core/utils"], function(module, require, exports) {
    function withAuthToken() {
        this.addAuthToken = function(b) {
            if (!authToken.get()) throw "addAuthToken requires a formAuthenticityToken";
            return b = b || {}, utils.merge(b, {
                authenticity_token: authToken.get()
            })
        }, this.addPHXAuthToken = function(b) {
            if (!authToken.get()) throw "addPHXAuthToken requires a formAuthenticityToken";
            return b = b || {}, utils.merge(b, {
    ...
    var authToken = require("app/utils/auth_token"),
        utils = require("core/utils");
...
define("app/utils/storage/core", ["module", "require", "exports", "core/compose", "core/advice"], function(module, require, exports) {
    ...
    function userData() {
        ...
        this.initialize = function(b) {
            ...
            var c = this.xmlDocEl.childNodes,
                d;
            ...
            var a = this.xmlDocEl.childNodes.length,
                b = [];
    ...
    function supportsLocalStorage() {
        if (doesLocalStorage === undefined) try {
    ...
    var compose = require("core/compose"),
        advice = require("core/advice"),
        memoryStore = {}, doesLocalStorage;
        ...
        var b = function() {
            var a = 14,
                ...
                e = function(a) {
                    ...
                    var b = [],
                        c = d ? [0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3] : [0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11],
                        e;
                    ...
                    var b = [],
                        c;
                    if (!d) for (c = 0; c < 4; c++) b[c * 4] = D[a[c * 4]] ^ E[a[1 + c * 4]] ^ a[2 + c * 4] ^ a[3 + c * 4], b[1 + c * 4] = a[c * 4] ^ D[a[1 + c * 4]] ^ E[a[2 + c * 4]] ^ a[3 + c * 4], b[2 + c * 4] = a[c * 4] ^ a[1 + c * 4] ^ D[a[2 + c * 4]] ^ E[a[3 + c * 4]], b[3 + c * 4] = E[a[c * 4]] ^ a[1 + c * 4] ^ a[2 + c * 4] ^ D[a[3 + c * 4]];
                    else for (c = 0; c < 4; c++) b[c * 4] = I[a[c * 4]] ^ G[a[1 + c * 4]] ^ H[a[2 + c * 4]] ^ F[a[3 + c * 4]], b[1 + c * 4] = F[a[c * 4]] ^ I[a[1 + c * 4]] ^ G[a[2 + c * 4]] ^ H[a[3 + c * 4]], b[2 + c * 4] = H[a[c * 4]] ^ F[a[1 + c * 4]] ^ I[a[2 + c * 4]] ^ G[a[3 + c * 4]], b[3 + c * 4] = G[a[c * 4]] ^ H[a[1 + c * 4]] ^ F[a[2 + c * 4]] ^ I[a[3 + c * 4]];
                    return b
                }, v = function(a, b, c) {
                    var d = [],
                        e;
...
define("app/utils/storage/array/with_max_elements", ["module", "require", "exports", "core/compose", "app/utils/storage/array/with_array"], function(module, require, exports) {
    function withMaxElements() {
        compose.mixin(this, [withArray]), this.maxElements = {}, this.getMaxElements = function(a) {
            ...
            var c = this.getArray(a),
                d = c.length + b - this.getMaxElements(a);
...
define("app/data/with_data", ["module", "require", "exports", "core/compose", "core/i18n", "app/utils/params", "app/data/with_auth_token", "app/utils/storage/custom"], function(module, require, exports) {
    function withData() {
        ...
        this.composeData = function(a, b) {
            ...
            e && b.isMutation === !1 && (e = !1), delete b.isMutation, this.trigger && e && this.trigger("dataPageMutated"), ["url"].forEach(function(a) {
                if (!b.hasOwnProperty(a)) throw new Error("getJSONRequest called without required option: " + a, arguments)
            });
            ...
            f = $.extend(f, this.extractParams(h, window.location)), b.success && (b.success = this.createSuccessHandler(b.success, b)), b.error && (b.error = this.createErrorHandler(b.error, b));
            var i = $.ajax($.extend(b, {
                url: b.url,
...
define("app/ui/with_interaction_data", ["module", "require", "exports", "core/utils"], function(module, require, exports) {
    function withInteractionData() {
        ...
        this.interactionData = function(a, b) {
            ...
            var f = utils.merge(this.getEventData(e), b),
                g = e.closest(this.attr.scribeContextSelector).data("scribe-context");
            ...
            var b = a.closest(this.attr.activityItemSelector),
                d = b.find(this.attr.activityTargetSelector);
            d.length || (d = a);
            ...
            var f = [],
                g = e.isNetworkActivity ? ".stream-item-activity-header" : "ol.activity-supplement";
            ...
            var b = this.getDataAttrs(a, d),
                c = a.closest(this.attr.discoveryStoryItemSelector),
                e = c.find(this.attr.discoveryStoryHeadlineSelector).text();
            return b.storyTitle = e.replace(/^\s+|\s+$/g, ""), b
        }, this.getTargetUserId = function(a) {
            var b = a.closest(this.attr.userTargetSelector);
            if (b.length) return b.closest("[data-user-id]").attr("data-user-id") || b.find("[data-user-id]").attr("data-user-id")
...
define("app/data/with_interaction_data_scribe", ["module", "require", "exports", "core/compose", "app/data/with_scribe", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "core/utils"], function(module, require, exports) {
    function withInteractionDataScribe() {
        compose.mixin(this, [withScribe]), this.scribeInteraction = function(a, b, c) {
            ...
            var d = {};
            b.url && (d.url = b.url), b.query && (d.query = b.query), b.impressionId && (d.promoted = !0);
            var e = this.interactionItem(b);
            e && (d.items = [e]);
            var f = this.interactionTarget(b, a);
            f && (d.targets = [f]), c = utils.merge(d, c, b.scribeData), b.conversationOriginTweetId && (c.associations = c.associations || {}, c.associations[associationTypes.conversationOrigin] = {
                association_id: b.conversationOriginTweetId,
                association_type: itemTypes.tweet
            }), this.scribe(a, b, c)
        }, this.interactionItem = function(a) {
            var b = {};
            if (a.position === 0 || a.position) b.position = a.position;
            ...
            switch (a.itemType) {
                case "user":
                    ...
                    break;
                case "tweet":
                    this.tweetDetails(b, a), this.cardDetails(b, a);
                    break;
                case "activity":
...
define("app/data/user_actions_scribe", ["module", "require", "exports", "core/component", "app/utils/scribe_item_types", "app/utils/scribe_association_types", "app/data/with_interaction_data_scribe"], function(module, require, exports) {
    function userActionsScribe() {
        ...
        this.defaultAttrs({
            ...
            this.on(document, "dataFollowStateChange dataUserActionSuccess", this.handleUserEvent), this.on(document, "uiMentionAction uiListAction uiDmAction uiRetweetOnAction uiRetweetOffAction uiDeviceNotificationsOnAction uiDeviceNotificationsOffAction uiShowMobileNotificationsConfirm uiShowPushTweetsNotificationsConfirm", this.handleAction)
        })
    }
    var defineComponent = require("core/component"),
        itemTypes = require("app/utils/scribe_item_types"),
    ...
    function itemActionsScribe() {
        this.handleNewerTimelineItems = function(a, b) {
            ...
            var c = b.sourceEventData,
                d = c.isMentionClick ? "mention_click" : "profile_click";
...
define("app/boot/scribing", ["module", "require", "exports", "app/data/scribe_transport", "app/data/scribe_monitor", "app/data/client_event", "app/data/ddg", "app/data/tweet_actions_scribe", "app/data/user_actions_scribe", "app/data/item_actions_scribe", "app/data/navigation_scribe"], function(module, require, exports) {
    function initialize(a) {
        ...
        }), TweetActionsScribe.attachTo(document, a), UserActionsScribe.attachTo(document, a), ItemActionsScribe.attachTo(document, a), NavigationScribe.attachTo(document, a)
    }
    var scribeTransport = require("app/data/scribe_transport"),
...
define("app/ui/navigation", ["module", "require", "exports", "core/component", "core/utils", "core/clock", "core/registry", "app/utils/full_path"], function(module, require, exports) {
    function navigation() {
        this.routes = {
            ...
            var b, c;
            if (a.shiftKey || a.ctrlKey || a.metaKey || a.which != undefined && a.which > 1) return;
            ...
            b.init_data.pushState || this.reloadPage(), this.trigger("uiBeforePageChanged", b), this.trigger("uiTeardown", b), $("body").attr("class", b.body_class_names), this.select("docContainer").attr("class", b.doc_class_names), this.select("pageContainer").attr("class", b.page_container_class_names);
            var d = b.banners ? b.banners + b.page : b.page;
            this.select("viewContainer").html(d), b.isPopState || $(window).scrollTop(0), using(b.module, function(a) {
...
define("app/data/navigation", ["module", "require", "exports", "core/component", "core/utils", "app/utils/time", "app/utils/full_path", "app/data/with_data"], function(module, require, exports) {
    function navigationData() {
        ...
        this.navigate = function(a, b) {
            var d = fullPath();
            c = b.href;
            if (b.href == d && this.pageCache[d]) return;
        ...
        }, this.hasDeployTimestampChanged = function(a) {
            var b = this.attr.assetsBasePath && this.attr.assetsBasePath.match(staticContentVersionRE),
                c = a.init_data.assetsBasePath && a.init_data.assetsBasePath.match(staticContentVersionRE);
            return b && c && c[1] != b[1]
            ...
            this.sweepPageCache(), this.trigger("uiBeforeNewPageLoad"), (b = this.pageCache[a]) ? (b.fromCache = !0, this.pageDataReceived(a, b)) : (this.trigger("dataPageFetch"), this.get({
                headers: this.attr.pustStateRequestHeaders,
                url: a,
                success: function(b) {
                    if (b.init_data && b.page && b.module) {
                        this.hasDeployTimestampChanged(b) && (location.href = a);
            ...
            b && (b.page = this.select("viewContainer").html(), b.page.length > this.attr.pushStatePageLimit && (delete this.pageCache[a], delete this.pageCacheTTLs[a]))
            ...
            if (this.handledPopstate) return;
            ...
            var a = fullPath(),
                b = utils.merge({}, this.attr.initialState, !0);
            b.page = this.select("viewContainer").html(), b.init_data = utils.merge({}, this.attr, !0), delete b.init_data.initialState, this.cacheState(a, b), history.replaceState({}, this.title, a)
    ...
    var component = require("core/component"),
        ...
        fullPath = require("app/utils/full_path"),
        withData = require("app/data/with_data"),
        NavigationData = component(navigationData, withData),
        pageCache = {}, pageCacheTTLs = {}, staticContentVersionRE = /\/a\/(\d+)/;
...
define("app/ui/with_dropdown", ["module", "require", "exports"], function(module, require, exports) {
    function withDropdown() {
        this.toggleDisplay = function(a) {
            ...
            this.closeDropdown(), this.activeEl && (a.preventDefault(), this.activeEl.focus(), this.activeEl = null)
        }, this.close = function(a) {
            var b = $(this.attr.toggler);
            if ((a.target === this.$node || this.$node.has(a.target).length > 0) && !this.isItemClick(a)) return;
            if (this.isItemClick(a) && this.ignoreCloseEvent) return;
            this.closeDropdown()
        }, this.isItemClick = function(a) {
            return !this.attr.itemSelector || !a ? !1 : $(a.target).closest(this.attr.itemSelector).length > 0
        }, this.after("initialize", function() {
            this.on(this.attr.toggler, "click", this.toggleDisplay), this.on(document, "click", this.close), this.on(document, "uiCloseDropdowns uiNavigate", this.closeDropdown), this.on(document, "uiShortcutEsc", this.closeAndRestoreFocus)
        })
    }
...
define("app/ui/language_dropdown", ["module", "require", "exports", "core/component", "app/ui/with_dropdown"], function(module, require, exports) {
    ...
    var defineComponent = require("core/component"),
        ...
        LanguageDropdown = defineComponent(languageDropdown, withDropdown);
...
define("app/ui/google", ["module", "require", "exports", "core/component"], function(module, require, exports) {
    ...
    var defineComponent = require("core/component"),
        GoogleAnalytics = defineComponent(googleAnalytics);
    ...
    module.exports = function(b, c, d) {
        ...
        if (arguments.length > 1 && String(c) !== "[object Object]") {
            ...
            if (typeof e.expires == "number") {
                var f = e.expires,
                    g = new Date((new Date).getTime() + f * 24 * 60 * 60 * 1e3);
                e.expires = g
            }
...
define("app/ui/impression_cookies", ["module", "require", "exports", "core/component", "app/utils/cookie"], function(module, require, exports) {
    function impressionCookies() {
        this.defaultAttrs({
            ...
            var d = $(c),
                e = d.closest("[data-impression-cookie]").attr("data-impression-cookie");
            if (!e) return;
...
define("app/ui/message_drawer", ["module", "require", "exports", "core/component"], function(module, require, exports) {
    function messageDrawer() {
        ...
        this.calculateFadeTimeout = function(a) {
            ...
            }), this.select("textSelector").html(c.message), this.select("closeSelector").hide(), this.$node.removeClass("hidden"), clearTimeout(this.messageTimeout), this.$node.stop(), this.messageTimeout = setTimeout(a.bind(this), this.calculateFadeTimeout(c.message))
    ...
    var defineComponent = require("core/component"),
        MessageDrawer = defineComponent(messageDrawer);
...
define("app/data/ttft_navigation", ["module", "require", "exports", "core/component", "app/data/scribe_transport"], function(module, require, exports) {
    function ttftNavigate() {
        this.beforeNewPageLoad = function(a, b) {
            ...
            if (this.ajaxCountdown && time.ajaxCount) return;
            if (this.listeningForTimeline && !time.timelineSuccess) return;
            var a = {
...
define("app/boot/common", ["module", "require", "exports", "app/utils/auth_token", "app/boot/scribing", "app/ui/navigation", "app/data/navigation", "app/ui/language_dropdown", "app/ui/google", "app/ui/impression_cookies", "app/data/promoted_logger", "app/ui/message_drawer", "app/ui/tooltips", "app/data/ttft_navigation", "app/utils/cookie", "app/utils/querystring", "app/data/user_info"], function(module, require, exports) {
    ...
    var authToken = require("app/utils/auth_token"),
        scribing = require("app/boot/scribing"),
        Navigation = require("app/ui/navigation"),
        ...
        ttftNavigationEnabled = !1,
        LOG_METHODS = ["log", "warn", "debug", "info"],
        NO_OP = function() {}, initialLoginTime = 0;
    module.exports = function(b) {
        var c = b.environment,
            d = ["production", "preflight"].indexOf(c) > -1;
        shimConsole(d), authToken.set(b.formAuthenticityToken), userInfo.set(b), ImpressionCookies.attachTo(document), GoogleAnalytics.attachTo(document), scribing(b), PromotedLogger.attachTo(document);
...
deferred('$lib/jquery.event.drag.js', function() {
    ...
    (function($) {
        $.fn.drag = function(a, b, c) {
            var d = typeof a == "string" ? a : "",
                e = $.isFunction(a) ? a : $.isFunction(b) ? b : null;
            ...
            c = b.drag = {
                ...
                hijack: function(b, d, e, f, g) {
                    ...
                    var h = {
                        ...
                        j, k = f || 0,
                        l, m, n, o = isNaN(f) ? e.interactions.length : f;
...
define("app/ui/with_dialog", ["module", "require", "exports", "core/compose", "app/ui/with_scrollbar_width", "$lib/jquery.event.drag.js"], function(module, require, exports) {
    function withDialog() {
        compose.mixin(this, [withScrollbarWidth]), this.center = function(a) {
            ...
            a.length && a.is(":not(:disabled)") && a.focus()
        }, this.hasFocus = function() {
            return $.contains(this.node, document.activeElement) || this.node == document.activeElement
        }, this.blur = function() {
            ...
            $(".modal-container:visible").length || $("body").removeClass("modal-enabled"), this.trigger("uiDialogClosed")
        }, this.blurAndClose = function() {
            this.blur(), this.$dialogContainer.fadeOut("fast", this.afterClose.bind(this))
        }, this.close = function() {
            ...
            this.$dialogContainer = this.$dialog || this.$node, this.$dialog = this.$dialogContainer.find("div.modal"), this.attr.closeSelector = this.attr.closeSelector || ".modal-close, .close-modal-background-target", this.on(this.select("closeSelector"), "click", this.close), this.on(document, "uiShortcutEsc uiCloseDialog uiBeforePageChanged", this.close), this.attr.triggerSelector && this.on(this.attr.triggerSelector, "click", this.triggerClicked)
        })
    }
    var compose = require("core/compose"),
...
define("app/ui/dialogs/signin_or_signup", ["module", "require", "exports", "core/component", "app/ui/with_position", "app/ui/with_dialog"], function(module, require, exports) {
    ...
    var defineComponent = require("core/component"),
        ...
        SigninOrSignupDialog = defineComponent(signinOrSignupDialog, withDialog, withPosition);
...
define("app/ui/forms/input_with_placeholder", ["module", "require", "exports", "core/component"], function(module, require, exports) {
    function inputWithPlaceholder() {
        this.defaultAttrs({
            ...
            if (this.$input.length != 1) throw new Error("InputWithPlaceholder must be attached to a container with exactly one input element inside of it");
            this.$placeholder = this.select("placeholder");
            if (this.$placeholder.length != 1) throw new Error("InputWithPlaceholder must be attached to a container with exactly one placeholder element inside of it");
    ...
    var defineComponent = require("core/component"),
        InputWithPlaceholder = defineComponent(inputWithPlaceholder);
...
define("app/ui/signup_call_out", ["module", "require", "exports", "core/component"], function(module, require, exports) {
    ...
    var defineComponent = require("core/component"),
        SignupCallOut = defineComponent(signupCallOut);
...
define("app/boot/logged_out", ["module", "require", "exports", "app/ui/dialogs/signin_or_signup", "app/ui/forms/input_with_placeholder", "app/ui/signup_call_out", "app/data/signup_click_scribe"], function(module, require, exports) {
    var SigninOrSignupDialog = require("app/ui/dialogs/signin_or_signup"),
...
define("app/utils/ttft", ["module", "require", "exports", "app/data/scribe_transport"], function(module, require, exports) {
    ...
    function scribeMilestones(a) {
        ...
        var b = !0;
        for (var c = 0; c < requiredMilestones.length; ++c) if (!(requiredMilestones[c] in window.ttftData)) {
            b = !1;
            break
        }(a || b) && scribeTTFTData(window.ttftData, b)
    }
    function onAjaxComplete(a, b, c) {
        if (c && c.url in newAjaxRequests) for (var d = 0; d < newAjaxRequests[c.url].length; d++) if (c === newAjaxRequests[c.url][d]) {
            newAjaxRequests[c.url].splice(d, 1);
            return
        }
        pendingAjaxCount--;
        if (pendingAjaxCount == 0 || $.active == 0) unbindAjaxHandlers(), recordPendingAjaxComplete()
    }
