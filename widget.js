...
__twttrlr(function(using, provide, loadrunner, define) {
    ...
    provide("util/uri", function(a) {
        using("util/querystring", "util/util", "util/twitter", function(b, c, d) {
            ...
            function f() {
                ...
                for (var b = 0, c; c = a[b]; b++) if (c.rel == "canonical") return e(c.href);
                return null
            }
            ...
            function g() {
                var a = document.getElementsByTagName("a"),
                    ...
                    i = /\bme\b/,
                    j;
                for (; e = c[g]; g++) for (h = 0; f = e[h]; h++) if (i.test(f.rel) && (j = d.screenName(f.href))) return j
            }
            a({
                absolutize: e,
                getCanonicalURL: f,
    ...
    provide("util/iframe", function(a) {
        a(function(a) {
            ...
            if (a.css) for (d in a.css) a.css.hasOwnProperty(d) && (c.style[d] = a.css[d]);
            if (a.attributes) for (e in a.attributes) a.attributes.hasOwnProperty(e) && c.setAttribute(e, a.attributes[e]);
    ...
    provide("tfw/util/tracking", function(a) {
        using("dom/cookie", "dom/sandbox", "util/donottrack", "tfw/util/guest_cookie", "tfw/util/env", "util/util", "$xd/json2.js", function(b, c, d, e, f, g, h) {
            function u() {
                function a(a) {
            ...
            function y(a, b, c) {
                var d, e, f, h, i, j = "https://r.twimg.com/jot?";
            ...
            function F() {
                ...
                return l++, a.action = "https://r.twimg.com/jot", a.method = "POST", a.target = "rufous-frame-" + l, a.id = "rufous-form-" + l, b.type = "hidden", b.name = "dnt", b.value = 0, a.appendChild(b), a
            }
    ...
    provide("tfw/util/assets", function(a) {
        using("util/env", function(b) {
            ...
            var c = {
                "embed/timeline.css": {
                    "default": "embed/timeline.c589b3cadbed15eba44ca85b5ebf4d4a.default.css",
                    "2x": "embed/timeline.c589b3cadbed15eba44ca85b5ebf4d4a.2x.css",
                    gif: "embed/timeline.c589b3cadbed15eba44ca85b5ebf4d4a.gif.css",
                    "default.rtl": "embed/timeline.c589b3cadbed15eba44ca85b5ebf4d4a.default.rtl.css",
                    "2x.rtl": "embed/timeline.c589b3cadbed15eba44ca85b5ebf4d4a.2x.rtl.css",
                    "gif.rtl": "embed/timeline.c589b3cadbed15eba44ca85b5ebf4d4a.gif.rtl.css"
                },
                "embed/embed.6c27ff0b627db7ce46be4331ae68cf0a.css": {
    ...
    provide("tfw/widget/syndicatedbase", function(a) {
        using("tfw/widget/base", "tfw/widget/intent", "tfw/util/assets", "tfw/util/globals", "dom/classname", "dom/delegate", "dom/sandbox", "util/env", "util/twitter", "util/util", function(b, c, d, e, f, g, h, i, j, k) {
            ...
            function u(a) {
                var b = f.present(document.documentElement, "twitter-dev") ? "components/syndication-templates/lib/css/index.css" : d("embed/timeline.css");
                t("twitter-widget-css", b, a)
            }
            ...
            var l = [".customisable", ".customisable:link", ".customisable:visited", ".customisable:hover", ".customisable:active", ".customisable-highlight:hover", "a:hover .customisable-highlight", "a:focus .customisable-highlight"],
            ...
            v.prototype = new b, k.aug(v.prototype, {
                ...
                bindIntentHandlers: function() {
                    ...
                    g.delegate(b, "click", ".profile", function(b) {
                        ...
                        d && (c.open(d), g.preventDefault(b))
                    }), g.delegate(b, "click", ".web-intent", function(b) {
                        a.addUrlParams(this);
                        if (b.altKey || b.metaKey || b.shiftKey) return;
                        c.open(this.href), g.preventDefault(b)
                    })
                }
                ...
                var c = a.getElementsByTagName("IMG"),
                    ...
                    i = 0,
                    j;
                for (; e = [c, d][i]; i++) if (e.length) for (j = 0; f = e[j]; j++) g = v.scaleDimensions(f.getAttribute("width") || f.width, f.getAttribute("height") || f.height, b, 375), g.width > 0 && (f.width = g.width), g.height > 0 && (f.height = g.height), h = g.height > h ? g.height : h;
                return h
            }, s(), a(v)
        })
    });
    provide("tfw/widget/timeline", function(a) {
        using("tfw/widget/syndicatedbase", "anim/transition", "tfw/widget/intent", "tfw/util/data", "tfw/util/tracking", "tfw/util/params", "util/css", "util/datetime", "util/env", "util/iframe", "util/insert", "util/throttle", "util/twitter", "util/querystring", "util/util", "dom/delegate", "dom/classname", "dom/get", function(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s) {
            function N(a) {
                if (!a) return;
                var c, d, e;
                this.a11yTitle = this._("Twitter Timeline Widget"), b.apply(this, [a]), c = this.params(), d = (c.chrome || this.dataAttr("chrome") || "").split(" "), this.preview = c.previewParams, this.widgetId = c.widgetId || this.dataAttr("widget-id"), this.widgetScreenName = c.screenName || this.dataAttr("screen-name"), this.widgetUserId = c.userId || this.dataAttr("user-id");
                if (c.showReplies === !0 || this.dataAttr("show-replies") == "true") this.widgetShowReplies = "true";
                d.length && (e = ~p.indexOf(d, "none"), this.chromeless = e || ~p.indexOf(d, "transparent"), this.headerless = e || ~p.indexOf(d, "noheader"), this.footerless = e || ~p.indexOf(d, "nofooter"), this.borderless = e || ~p.indexOf(d, "noborders")), this.headingStyle = h.sanitize(c.headingStyle || this.dataAttr("heading-style"), undefined, !0), this.classAttr.push("twitter-timeline-rendered"), this.ariaPolite = c.ariaPolite || this.dataAttr("aria-polite")
            }
            ...
            var t = "1.0",
                ...
                F = "permalink",
                G = "tweet-box-button",
                H = "twitter-follow-button",
                I = "no-more-pane",
                J = "pending-scroll-in",
                K = "pending-new-tweet",
                L = "show-new-tweet",
                M = "show-tweet-box";
            N.prototype = new b, p.aug(N.prototype, {
                ...
                create: function(a) {
                    ...
                    if (!d) return;
                    this.reconfigure(a.config), this.augmentWidgets(d), b.retinize(d), b.constrainMedia(d, this.contentWidth()), this.searchQuery = d.getAttribute("data-search-query"), this.profileId = d.getAttribute("data-profile-id"), k = this.getTweetDetails(c);
                    ...
                    return f.enqueue({
                        ...
                        e.sandbox.body.appendChild(d), e.sandbox.win.setTimeout(function() {
                            var a = s.one(x, d, "DIV"),
                                b = s.one(y, d, "DIV"),
                                c = s.one(z, d, "DIV");
                            b ? g = a.offsetHeight + b.offsetHeight : g = a.offsetHeight, c.style.cssText = "height:" + (e.height - g - 2) + "px"
                ...
                render: function(a, b) {
                    ...
                    function k() {
                        f.initPostLogging(), e.timeline({
                            ...
                            lang: c.lang,
                            success: function(a) {
                                c.element = c.create(a), c.readTranslations(), c.bindInteractions(), a.headers.xPolling && /\d/.test(a.headers.xPolling) && (c.pollInterval = a.headers.xPolling * 1e3), c.updateTimeStamps(), c.schedulePolling(), b && b(c.sandbox.frame);
                                return
                            },
                            error: function(a) {
                                a && a.headers && b && b(a.headers.status)
                ...
                getTweetDetails: function(a) {
                    ...
                    for (; d = b[i]; i++) e = s.one(F, d, "A"), f = n.status(e.href), g = d.getAttribute("data-tweet-id"), f === g ? c[f] = {
                        item_type: h.TWEET
                    } : c[f] = {
                        item_type: h.RETWEET,
                        target_type: h.TWEET,
                ...
                bindInteractions: function() {
                    var a = this,
                        b = this.element,
                        c = !0;
                    this.bindIntentHandlers(), q.delegate(b, "click", "." + E, function(c) {
                        if (c.altKey || c.metaKey || c.shiftKey) return;
                        O(s.ancestor("." + B, this, b), a.contentWidth()), q.stop(c)
                    }), q.delegate(b, "click", "A", function(a) {
                        q.stopPropagation(a)
                    }), q.delegate(b, "click", ".with-expansion", function(b) {
                        O(this, a.contentWidth()), q.stop(b)
                    }), q.delegate(b, "click", ".load-more", function(b) {
                        a.loadMore()
                    }), q.delegate(b, "click", "." + w, function(b) {
                    ...
                    }), q.delegate(b, "mouseover", "." + v, function(b) {
                        a.mouseOver = !0
                    }), q.delegate(b, "mouseout", "." + v, function(b) {
                        a.mouseOver = !1
                    }), q.delegate(b, "mouseover", "." + w, function(b) {
                        a.mouseOverNotifier = !0
                    }), q.delegate(b, "mouseout", "." + w, function(b) {
                ...
                insertNewTweets: function(a) {
                    ...
                    r.remove(this.element, J), e.style.cssText = "margin-top: -" + g + "px", window.setTimeout(function() {
                        d.scrollTop = 0, r.add(b.element, J), j.cssTransitions() ? e.style.cssText = "" : c.animate(function(a) {
                ...
                showNewTweetNotifier: function() {
                    var a = this,
                        ...
                        c = b.children[0];
                    b.style.cssText = "", r.add(this.element, K), b.removeChild(c), b.appendChild(c), r.replace(this.element, K, L), this.newNoticeDisplayTime = +(new Date), window.setTimeout(function() {
                        a.hideNewTweetNotifier()
                    }, 5e3)
                },
                hideNewTweetNotifier: function(a) {
                    var b = this,
                        c = s.one(w, this.element, "DIV");
                    if (!a && this.mouseOverNotifier) return;
                    r.replace(this.element, L, K), window.setTimeout(function() {
                        r.remove(b.element, K)
                    }, 500)
                },
                ...
                updateTimeStamps: function() {
                    var a = s.all(F, this.element, "A"),
                        ...
                        e, f;
                    for (; b = a[d]; d++) {
                        e = b.getAttribute("data-datetime"), f = e && i.timeAgo(e, this.i18n), c = b.getElementsByTagName("TIME")[0];
                        if (!f) continue;
                        if (c && c.innerHTML) {
                            c.innerHTML = f;
                            continue
    ...
    provide("tfw/widget/embed", function(a) {
        using("tfw/widget/base", "tfw/widget/syndicatedbase", "tfw/util/params", "dom/classname", "dom/get", "util/util", "util/throttle", "util/twitter", "tfw/util/data", "tfw/util/tracking", function(b, c, d, e, f, g, h, i, j, k) {
            function p(a, b, c) {
                var d = f.one("subject", a, "BLOCKQUOTE"),
                    e = f.one("reply", a, "BLOCKQUOTE"),
                    g = d && d.getAttribute("data-tweet-id"),
            ...
            function s(a) {
                if (!a) return;
                var b, d, e;
                this.a11yTitle = this._("Embedded Tweet"), c.apply(this, [a]), b = this.params(), d = this.srcEl && this.srcEl.getElementsByTagName("A"), e = d && d[d.length - 1], this.hideThread = (b.conversation || this.dataAttr("conversation")) == "none" || ~g.indexOf(this.classAttr, "tw-hide-thread"), this.hideCard = (b.cards || this.dataAttr("cards")) == "hidden" || ~g.indexOf(this.classAttr, "tw-hide-media");
                if ((b.align || this.attr("align")) == "left" || ~g.indexOf(this.classAttr, "tw-align-left")) this.align = "left";
                else if ((b.align || this.attr("align")) == "right" || ~g.indexOf(this.classAttr, "tw-align-right")) this.align = "right";
                else if ((b.align || this.attr("align")) == "center" || ~g.indexOf(this.classAttr, "tw-align-center")) this.align = "center", this.containerWidth > this.dimensions.MIN_WIDTH * (1 / .7) && this.width > this.containerWidth * .7 && (this.width = this.containerWidth * .7);
                this.narrow = b.narrow || this.width <= this.dimensions.NARROW_WIDTH, this.narrow && this.classAttr.push("var-narrow"), this.tweetId = b.tweetId || e && i.status(e.href)
            }
            var l = "2.0",
                m = "tweetembed",
                n = {}, o = {};
            s.prototype = new c, g.aug(s.prototype, {
                ...
                render: function(a, b) {
                    ...
                    this.hideCard && (d += "c"), this.hideThread && (d += "t"), d && (e += "-" + d), h = this.callsWhenSandboxReady(function(a) {
                        function d() {
                            c.srcEl && c.srcEl.parentNode && c.srcEl.parentNode.removeChild(c.srcEl), c.handleResize()
                        }
                        var b;
                        c.sandbox.doc.body.style.display !== "none" && c.sandbox.frame.offsetHeight && c.element.offsetHeight ? d() : b = window.setInterval(function() {
                            c.sandbox.doc.body.style.display !== "none" && c.sandbox.frame.offsetHeight && c.element.offsetHeight && (window.clearInterval(b), d())
                        }, 100)
                    }), f = this.callsWhenSandboxReady(function(a, d) {
                        c.element = c.create(d), c.bindIntentHandlers(), b && b(c.sandbox.frame)
                    }), g = this.callsWhenSandboxReady(function(a) {
                        q(c.tweetId, c.partner, c.dnt)
                    }), r(e, this.lang, f, g, h)
                },
                augmentWidgets: function(a) {
                    var b = f.all("twitter-follow-button", a, "A"),
                        c, d = 0;
                ...
                addUrlParams: function(a) {
                    ...
                    return this.addUrlParams = d(c, function(a) {
                        var c = f.ancestor(".tweet", a, b.element);
                        return {
                            tw_i: c.getAttribute("data-tweet-id")
                        }
                    }), this.addUrlParams(a)
                ...
                handleResize: function() {
                    this.handleResize = h(function() {
                        ...
                        if (!this.element) return;
                        b < this.dimensions.NARROW_WIDTH ? (this.narrow = !0, e.add(this.element, "var-narrow")) : (this.narrow = !1, e.remove(this.element, "var-narrow")), window.setTimeout(function() {
                ...
                n = {};
                if (a.keys) b = a.keys();
                else for (d in a) a.hasOwnProperty(d) && b.push(d);
                if (!b.length) return;
                k.initPostLogging(), e = a[b[0]][0].lang, j.tweets({
                    ids: b.sort(),
                    lang: e,
                    complete: function(b) {
                        var c, d, e, f, g, h, i = [];
            ...
            }, b.afterLoad(s.fetchAndRender), a(s)
        })
    });
    ...
    provide("tfw/widget/tweetbutton", function(a) {
        using("tfw/widget/tweetbase", "util/util", "util/querystring", "util/uri", "dom/textsize", function(b, c, d, e, f) {
            var g = document.title,
                ...
                j = function(a) {
                    ...
                    this.counturl = d.counturl || this.dataAttr("counturl"), this.searchlink = d.searchlink || this.dataAttr("searchlink"), this.button_hashtag = d.button_hashtag || d.hashtag || this.dataAttr("button-hashtag"), this.size = j == "large" ? "l" : "m", this.type ? (this.count = "none", k && (this.related = this.related ? k + "," + this.related : k)) : (this.text = this.text || g, this.url = this.url || e.getCanonicalURL() || h, this.count = ~c.indexOf(i, f) ? f : "horizontal", this.count = this.count == "vertical" && this.size == "l" ? "none" : this.count, this.via = this.via || k)
                };
            j.prototype = new b, c.aug(j.prototype, {
                parameters: function() {
                    var a = {
                        text: this.text,
                        url: this.url,
                ...
                width: function() {
                    var a = {
                        ...
                        n = this.styles.base,
                        o = n;
                    return~c.indexOf(["ja", "ko"], this.lang) ? i += this._("10k unit") : i = i.length > h.length ? i : h, b ? (o = n.concat(this.styles.vbubble), m = a.ver, l = a.btn) : this.size == "l" ? (n = o = n.concat(this.styles.large), l = a.xlbtn, m = a.xlcnt) : (l = a.btn, m = a.cnt), this.count != "none" && (k = f(i, "", o).width + m), j = f(e, "", n.concat(this.styles.button)).width + l, b ? j > k ? j : k : this.calculatedWidth = j + k
                },
                render: function(a, b) {
                    var c = twttr.widgets.config.assetUrl() + "/widgets/tweet_button.1363148939.html#" + this.parameters();
        ...
        using("util/util", "tfw/widget/base", "util/querystring", "util/uri", "util/twitter", "dom/textsize", function(b, c, d, e, f, g) {
            ...
            h.prototype = new c, b.aug(h.prototype, {
                ...
                render: function(a, b) {
                    ...
                    var c = twttr.widgets.config.assetUrl() + "/widgets/follow_button.1363148939.html#" + this.parameters();
