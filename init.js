...
(function(a, b) {
    ...
    q.extend({
        ...
        map: function(a, c, d) {
            var e, f, g = [],
                i = 0,
                j = a.length,
                k = a instanceof q || j !== b && typeof j == "number" && (j > 0 && a[0] && a[j - 1] || j === 0 || q.isArray(a));
            if (k) for (; i < j; i++) {
                e = c(a[i], i, d);
                e != null && (g[g.length] = e)
            } else for (f in a) {
    ...
    q.event = {
        ...
        c) {
            ...
            if (u.preDispatch && u.preDispatch.call(this, c) === !1) return;
    ...
    q.fn.extend({
        ...
        closest: function(a, b) {
            var c, d = 0,
                e = this.length,
                f = [],
                g = ib.test(a) || typeof a != "string" ? q(a, b || this.context) : 0;
            for (; d < e; d++) {
                c = this[d];
    ...
    q.fn.extend({
        ...
        domManip: function(a, c, d) {
            ...
            if (q.isFunction(k)) return this.each(function(e) {
                var f = q(this);
            ...
            if (this[0]) {
                ...
                if (f) {
                    c = c && q.nodeName(f, "tr");
                    for (i = e.cacheable || m - 1; j < m; j++) d.call(c && q.nodeName(this[j], "table") ? Fb(this[j], "tbody") : this[j], j === i ? g : q.clone(g, !0, !0))
                }
                g = f = null;
            ...
            (i = a[f]) != null; f++) {
                ...
                if (typeof i == "string") if (!ub.test(i)) i = b.createTextNode(i);
                    ...
                    if (!q.support.tbody) {
                        ...
                        for (g = o.length - 1; g >= 0; --g) q.nodeName(o[g], "tbody") && !o[g].childNodes.length && o[g].parentNode.removeChild(o[g])
    ...
    q.each(["height", "width"], function(a, b) {
        q.cssHooks[b] = {
            get: function(a, c, d) {
                if (c) return a.offsetWidth === 0 && Qb.test(Kb(a, "display")) ? q.swap(a, Wb, function() {
                    return ec(a, b, d)
                }) : ec(a, b, d)
            },
            set: function(a, c, d) {
...
(function(a) {
    ...
    Function.prototype.bind || (Function.prototype.bind = function(b) {
        var c = this;
        if (typeof c != "function") throw new TypeError("Function.prototype.bind called on incompatible " + c);
    ...
    Array.prototype.forEach || (Array.prototype.forEach = function(b) {
        ...
        while (++f < g) f in c && b.call(d, c[f], f, c)
    });
    ...
    Array.prototype.reduceRight || (Array.prototype.reduceRight = function(b) {
        ...
        do g in this && (f = b.call(void 0, f, c[g], g, c));
        while (g--);
        return f
    });
